...
class StudentAccessController extends Controller
{
    ...
    {
        return Inertia::render('StudentAccess', [
    ...
    {
        $this->ensureStudentAccount($request);
        ...
        return $this->loginPipeline($request)->then(function (LoginRequest $request) {
            ...
            if (! $user || ! $user->hasRole('student')) {
                ...
                throw ValidationException::withMessages([
                    Fortify::username() => ['Cet espace est reserve aux eleves.'],
                ]);
            }
    ...
    private function ensureStudentAccount(LoginRequest $request): void
    {
