...
export default function LevelsIndex({ filters, levels }: PageProps) {
    ...
    const handleDelete = (id: number) => {
        ...
        router.delete(`/establishment-admin/levels/${id}`, {
            preserveScroll: true,
        });
    };
                ...
                <div className="flex flex-col gap-4 rounded-xl border border-sidebar-border/70 bg-background p-6 md:flex-row md:items-center md:justify-between">
                    <div>
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">
                            Manage levels for your establishment.
                        </p>
                    </div>

                    <Button asChild>
                        <Link href="/establishment-admin/levels/create">
                            Add level
                        </Link>
                    </Button>
                </div>
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-3">
                                                <div className="flex justify-end gap-2">
                                                    ...
                                                    >
                                                        <Link
                                                            href={`/establishment-admin/levels/${level.id}`}
                                                        >
                                                            View
                                                        </Link>
                                                    </Button>
